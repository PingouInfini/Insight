package com.pingouinfini.insight.repository.search.impl;
...
@Repository
public class InsightEntitySearchRepository implements com.pingouinfini.insight.repository.search.InsightEntitySearchRepository {
    ...
    private void postConstruct() {
        ...
        for (BeanDefinition bd : scanner.findCandidateComponents("com.pingouinfini.insight.domain")) {
            try {
